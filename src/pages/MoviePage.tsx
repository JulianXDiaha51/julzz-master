...
export default function MoviePage() {
  ...
  const seoData = generatePageSEOData({
    title: 'Nonton Anime Movie Sub Indo HD Gratis - JulzzNimeV2',
    description: 'Nonton anime movie subtitle Indonesia gratis di JulzzNimeV2. Koleksi lengkap anime movie terbaru dengan kualitas HD 720p tanpa iklan.',
