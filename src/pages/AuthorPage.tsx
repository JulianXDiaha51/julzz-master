  ...
  const authors: Author[] = [
    {
      ...
      github: 'https://github.com/JulianzzGITHUB',
      description: 'Developer utama JulzzNimeV2. Bertanggung jawab untuk pengembangan frontend dan UI/UX aplikasi.',
      avatar: 'https://files.catbox.moe/aq7uxy.jpg',
      website: 'https://undefined.com',
      skills: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Bun', 'Elysia', 'etc']
    },
    {
      name: 'Fatih Firdaus',
      role: 'Penyedia API/Backend',
      github: 'https://github.com/Ryzensh',
      description: 'Developer backend dan penyedia API Ryzumi untuk JulzzNimeV2.',
    ...
    },
    {
      name: 'Sandika',
      role: 'Penyedia API/Backend',
      github: 'https://github.com/Sangkafollowe',
      description: 'Penyedia API Sankanime untuk JulzzNimeV2',
    ...
    },
    {
      ...
      github: 'https://github.com/JulianzzGITHUB',
      description: 'Pendukung setia Project JulzzNimeV2',
      avatar: 'https://files.catbox.moe/aq7uxy.jpg',
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-12 text-center text-gray-600 dark:text-gray-400">
          <p className="flex items-center justify-center gap-2">
            JulzzNimeV2 adalah platform streaming anime yang dikembangkan dengan ❤️ oleh JulianDev.
          </p>
          <p className="mt-2 flex items-center justify-center gap-2">
            Powered by <a href="https://antidonasi.web.id" className='text-blue-600 dark:text-blue-500 font-bold' target="_blank" rel="noopener noreferrer">JulianDev</a>
          </p>
        </div>
      </div>
    </div>
