...
function HomePage() {
  ...
  const seoData = generatePageSEOData({
    title: 'JulzzNimeV2 - Nonton Anime Sub Indo HD Gratis Tanpa Iklan',
    ...
    keywords: 'julzznime, julzz nime, julzz anime, nonton anime, nonton anime sub indo, streaming anime, streaming anime sub indo, anime tanpa iklan, anime gratis, anime sub indo, anime subtitle indonesia, anime ongoing, anime complete, anime movie, anime terbaru, anime terlengkap',
    url: '/',
  });
